...
// ⚠️ TEMPORARY: Set to true to bypass Firebase auth for dev preview. Set back to false before production.
const DEV_BYPASS_AUTH = false;

export const AuthProvider = ({ children }: { children: React.ReactNode }) => {
  const [user, setUser] = useState<FirebaseUser | null>(
    DEV_BYPASS_AUTH ? { uid: 'dev-user', email: 'dev@preview.local', displayName: 'Dev Preview', photoURL: null } : null
  );
